...
class LabelOptionsTest {
    @Test
    fun `physical sizes use established design canvas dimensions`() {
    ...
    fun `unknown persisted options safely use defaults`() {
        ...
        assertEquals(LabelDesign.BARCODE, LabelDesign.fromName("STANDARD"))
        assertEquals(LabelDesign.QR_CODE, LabelDesign.fromName("QR_CODE"))
    }
}
